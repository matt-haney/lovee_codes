...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Program make_synthetic_ex2_rayleigh is a Matlab script to make some 
% synthetic phase or group velocity data for Rayleigh/Scholte waves. 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Output:
...
vplay2 = 3096; vslay2 = vplay2/vpvsr; rholay2 = gardc*(vplay2^powr);
...
% Number of fluid elements, Nf, listed above

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Program lovee_invert is a Matlab script to invert any collection of 
% fundamental mode/higher mode Love wave group or phase 
...
% inp(1)                            % input skipped for Love waves
...
% inp(7)                            % input skipped for Love waves
...
[U, snsmf_vstot] = lovee_sensitivity(Nn,vsv,rhov,fks,h,modn,vflg);
...
[U, snsmf_vstot] = lovee_sensitivity(Nn,vsv,rhov,fksr,h,modnr,vflgr);                

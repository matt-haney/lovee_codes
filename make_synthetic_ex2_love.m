...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Program make_synthetic_ex2_love is a Matlab script to make some synthetic 
% phase or group velocity data for Love waves. It writes out 
% input files for eventual use by the program lovee_invert.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Output:
...
vplay2 = 3696; vslay2 = vplay2/vpvsr; rholay2 = gardc*(vplay2^powr);
